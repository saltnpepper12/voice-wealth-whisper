...
const Hero = () => {
  return (
    <section className="relative overflow-hidden py-20 lg:py-28">
      ...
      <div 
        className="absolute top-0 right-0 w-96 h-96 bg-incluya-yellow opacity-30 blob-shape animate-float" 
        style={{ zIndex: -1 }}
      ></div>
      <div 
        className="absolute bottom-0 left-0 w-72 h-72 bg-incluya-turquoise opacity-20 blob-shape animate-float"
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          <div className="flex-1 max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" className="bg-transparent border-incluya-turquoise-dark text-incluya-turquoise-dark hover:bg-incluya-turquoise/20 text-lg py-6 px-8">
                How It Works
              </Button>
            </div>
            <div className="mt-8 flex items-center gap-4">
              ...
              <p className="text-sm text-gray-600">Join 1000+ people reducing financial stress</p>
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-md lg:max-w-none mx-auto">
            <div className="relative">
              <div className="glass-panel p-6 rounded-3xl">
                <h3 className="font-serif text-2xl font-semibold mb-4 text-center">Money Journey</h3>
