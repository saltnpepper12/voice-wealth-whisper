  ...
  return (
    <section className="bg-incluya-peach/20 py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-md glass-panel p-8">
          {/* Top left squiggle */}
          ...
          <h3 className="font-serif text-2xl font-semibold mb-6 relative z-10">Self-Compassion</h3>
          ...
          <div className="relative z-10">
            ...
            <p className="font-medium">- Sharon Salzberg</p>
          </div>
