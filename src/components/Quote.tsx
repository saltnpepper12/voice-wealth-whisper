...
const Quote = () => {
  return (
    <section className="relative py-20 bg-incluya-turquoise/40 backdrop-blur-sm overflow-hidden">
      {/* Decorative elements */}
      <div 
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <svg className="w-12 h-12 mx-auto mb-6 text-incluya-yellow-dark" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-lg font-medium text-white/90">Sharon Salzberg</p>
        </div>
      </div>
    </section>
  );
