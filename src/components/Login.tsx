    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute top-4 left-4 sm:top-6 sm:left-6 z-20">
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-incluya-yellow via-incluya-yellow-dark to-incluya-yellow bg-[length:200%_100%] rounded-lg opacity-70 animate-[shimmer_2s_ease-in-out_infinite] group-hover:opacity-100 transition-opacity"></div>
          <Button
            variant="ghost"
            onClick={() => navigate('/')}
            className="relative flex items-center gap-1 sm:gap-2 text-white/90 hover:text-white hover:bg-white/20 backdrop-blur-sm font-serif text-xs sm:text-base p-2 sm:px-4 sm:py-2 bg-black/20"
          >
      ...
      <div className="relative z-10 w-full max-w-md px-6 sm:px-8 pt-16 sm:pt-0">
        <div className="space-y-6 sm:space-y-8">
          ...
          {/* Social Signup Buttons with animated gold outlines */}
          <div className="space-y-3 mb-6 opacity-0 animate-[fade-in_1.2s_ease-out_1.2s_forwards]">
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-incluya-yellow via-incluya-yellow-dark to-incluya-yellow bg-[length:200%_100%] rounded-md opacity-70 animate-[shimmer_3s_ease-in-out_infinite] group-hover:opacity-100 transition-opacity"></div>
              <Button
                variant="outline"
                className="relative w-full flex items-center justify-center gap-3 py-3 sm:py-4 bg-black/20 border-transparent text-white hover:bg-black/30 hover:text-white backdrop-blur-sm font-serif text-sm sm:text-base transition-all duration-200 shadow-lg"
                type="button"
              >
            ...
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-incluya-yellow via-incluya-yellow-dark to-incluya-yellow bg-[length:200%_100%] rounded-md opacity-70 animate-[shimmer_3s_ease-in-out_infinite_0.5s] group-hover:opacity-100 transition-opacity"></div>
              <Button
                variant="outline"
                className="relative w-full flex items-center justify-center gap-3 py-3 sm:py-4 bg-black/20 border-transparent text-white hover:bg-black/30 hover:text-white backdrop-blur-sm font-serif text-sm sm:text-base transition-all duration-200 shadow-lg"
                type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-4 opacity-0 animate-[fade-in_1.2s_ease-out_1.8s_forwards]">
            ...
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-incluya-yellow via-incluya-yellow-dark to-incluya-yellow bg-[length:200%_100%] rounded-md opacity-70 animate-[shimmer_3s_ease-in-out_infinite_1s] group-hover:opacity-100 transition-opacity"></div>
              <Button
                type="submit"
                disabled={!agreeToTerms}
                className="relative w-full bg-black/30 hover:bg-black/40 text-white py-3 sm:py-4 font-medium backdrop-blur-md border-transparent transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-serif text-base shadow-lg"
              >
                Begin Your Journey
              </Button>
            </div>
